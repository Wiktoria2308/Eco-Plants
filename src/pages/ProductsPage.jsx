      ...
      <div className="dropdown-wrapper" ref={dropdownRef}>
        <div className={`dropdown ${dropdownOpen ? "open" : ""}`}>
          <button className="dropdown-btn" onClick={toggleDropdown}>
            Sort by{" "}
            {dropdownOpen ? (
              <SlArrowUp className="sort-arrow-up" />
            ) : (
              <SlArrowDown className="sort-arrow-down" />
            )}
          </button>
          <div className="dropdown-content">
            ...
            <label
              className={`dropdown-option ${
                sortOrder === "lowest-price" ? "selected" : ""
              }`}
              onClick={() =>
                handleSortOrder({ target: { value: "lowest-price" } })
              }
            >
              <span className="option-text">Lowest price</span>
              {sortOrder === "lowest-price" && (
                <FcCheckmark className="dropdown-checkmark" />
              )}
            </label>
            <label
              className={`dropdown-option ${
                sortOrder === "highest-price" ? "selected" : ""
              }`}
              onClick={() =>
                handleSortOrder({ target: { value: "highest-price" } })
              }
            >
